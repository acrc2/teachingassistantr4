...
cucumber_1.defineSupportCode(function ({ Given, When, Then }) {
    Given(/^I am at the students page$/, () => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.get("http://localhost:3000/alunos").then(body => expect(body).toBe("[]")).catch(e => expect(e).toEqual(null));
    }));
    /*Given(/^The student "([^\"]*)" with CPF "(\d*)" is registered in the students list$/, async (name, cpf) => {
    ...
    Then(/^I cannot see "([^\"]*)" with CPF "(\d*)" in the students list anymore$/, async (name, cpf) => {
